...
from config import DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, MIN_WINDOW_WIDTH, MIN_WINDOW_HEIGHT, MAX_WINDOW_WIDTH, MAX_WINDOW_HEIGHT
...
def parse_args():
    ...
    w = pygame.math.clamp(w, MIN_WINDOW_WIDTH, MAX_WINDOW_WIDTH)
    h = pygame.math.clamp(h, MIN_WINDOW_HEIGHT, MAX_WINDOW_HEIGHT)
    return w, h
