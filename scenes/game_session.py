...
import config
from config import ACTIVE_BALL_Y, GRAVITY, FRICTION, ADDITIONAL_RADIUS, BG_COLOR, BACKGROUND_IMAGE_FILE, BUTTON_CLICK_SOUND_FILE, MERGE_SOUND_FILE, COLLISION_SOUND_FILE, BEST_SCORE_FILE, BALL_IS_IMAGE, SOUND_VOLUME
from config import BALL_DICTIONARY, BASKET_HORIZONTAL_MARGIN, BASKET_BOTTOM_MARGIN, BASKET_HEIGHT_RATIO
...
class GameSessionScene(Scene):
    ...
    def update(self, dt):
        ...
        self.balls, merged_count = simulate_physics(self.balls, GRAVITY, FRICTION, self.basket, dt=1, iterations=6, additional_radius=ADDITIONAL_RADIUS, merge_sound=self.merge_sound, collision_sound=self.collision_sound)
